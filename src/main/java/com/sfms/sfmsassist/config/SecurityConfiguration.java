...
/*	@Override
	...
	*/
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
				...
				.and().
				formLogin().loginPage("/loginform").defaultSuccessUrl("/").permitAll().
				and()
				.addFilterAfter(new AngularCsrfFilter(), CsrfFilter.class)
				...
				.sessionManagement().maximumSessions(1).expiredUrl("/loginform").sessionRegistry(getSessionRegistry());
	...
	*/
	...
	public LogoutSuccessHandler getLogoutSuccessHandler() {
		...
		logoutSuccessHandler.setDefaultTargetUrl("/loginform");
